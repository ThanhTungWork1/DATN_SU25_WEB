    ...
    return (
      <div className="related-products-section mt-5">
        ...
        <div style={{ fontSize: '12px', color: '#666', marginTop: '10px' }}>
          ...
          <p>Debug: relatedProducts = {relatedProducts ? 'exists' : 'null/undefined'}</p>
  ...
  return (
    <div className="related-products-section mt-5">
      ...
      <div className="related-products-pagination-bar">
        ...
        <div className="related-products-grid">
          {console.log('🔍 [RelatedProducts DEBUG] paginatedProducts:', paginatedProducts)}
          {paginatedProducts.map((product) => {
            console.log('🔍 [RelatedProducts DEBUG] Rendering product:', product.id, product.name);
