...
export const useProductDetail = (id: string) => {
  console.log('🔍 [useProductDetail DEBUG] Hook called with id:', id);
  
  return useQuery({
    queryKey: ["product", id],
    queryFn: async () => {
      console.log('🔍 [useProductDetail DEBUG] Starting API call for id:', id);
      const result = await getProductDetail(id);
      console.log('🔍 [useProductDetail DEBUG] API result:', result);
      return result;
    },
    enabled: !!id,
