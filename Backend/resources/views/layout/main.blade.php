                    ...
                    <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img src="./build/assets/images/profile/user-1.jpg" alt="" width="35" height="35"
                                    ...
                                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="./build/assets/images/profile/user-3.jpg"
                                            ...
                                            <tr>
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="./build/assets/images/profile/user-5.jpg"
                                                            class="rounded-circle" width="40" alt="flexy" />
                                                        <div class="ms-3">
                                            ...
                                            <tr>
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="./build/assets/images/profile/user-6.jpg"
                                                            class="rounded-circle" width="40" alt="flexy" />
                                                        <div class="ms-3">
                                                            <h6 class="mb-0 fw-bolder">
                                                                Christopher Jamil
                                            ...
                                            <tr>
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="./build/assets/images/profile/user-7.jpg"
                                                            class="rounded-circle" width="40" alt="flexy" />
                                                        <div class="ms-3">
                                            ...
                                            <tr>
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="./build/assets/images/profile/user-8.jpg"
                                                            class="rounded-circle" width="40" alt="flexy" />
                                                        <div class="ms-3">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable mb-2 common-widget" style="height: 465px"
                                ...
                                <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                                    <div>
                                        <span><img src="./build/assets/images/profile/user-3.jpg" class="rounded-circle"
                          ...
                          ">April 14, 2025</span>
                                ...
                                <div class="d-flex flex-row comment-row border-bottom active p-3 gap-3">
                                    <div>
                                        <span><img src="./build/assets/images/profile/user-5.jpg" class="rounded-circle"
                                                alt="user" width="50" /></span>
                                    </div>
                          ...
                          ">April 14, 2025</span>
                                ...
                                <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                                    <div>
                                        <span><img src="./build/assets/images/profile/user-6.jpg" class="rounded-circle"
                                                alt="user" width="50" /></span>
                                    </div>
                                    <div class="comment-text w-100">
                          ...
                          ">April 14, 2025</span>
                                ...
                                <div class="d-flex flex-row comment-row p-3 gap-3">
                                    <div>
                                        <span><img src="./build/assets/images/profile/user-4.jpg" class="rounded-circle"
                                                alt="user" width="50" /></span>
                                    </div>
                                    <div class="comment-text w-100">
                                        <h6 class="fw-medium">James Anderson</h6>
