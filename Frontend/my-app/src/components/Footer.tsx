      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <p className="small">
              Đăng ký để nhận thông tin sản phẩm mới, khuyến mãi & sự kiện từ
              StrideX.
            </p>
        ...
        <div className="footer-desc small mb-3">
          StrideX – Trang web bán đồ thể thao uy tín với sản phẩm đa dạng như
          giày chạy bộ, quần áo thể thao, phụ kiện chất lượng từ các thương hiệu
          hàng đầu. Giao hàng toàn quốc, hỗ trợ đổi trả nhanh chóng.
        </div>
