...
//   console.log("SidebarMenu rendering, path:", path);
...
//       ? "2"
//       : path.startsWith("/admin/categories") && !path.includes("statistics")
//         ? "3"
//         : path.startsWith("/admin/category-statistics")
//           ? "9" // Thống kê danh mục
...
//           label: <a href="/admin/category-statistics">Thống kê danh mục</a>,
//         },
//         {
//           key: "4",
