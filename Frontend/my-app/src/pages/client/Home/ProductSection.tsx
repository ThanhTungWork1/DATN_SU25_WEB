      ...
      <div className="fashion-row">
        {products.slice(0, 4).map((product) => (
          <div className="fashion-card" key={product.id} data-aos="zoom-in">
            ...
            <div>
              <span className="fashion-price">{product.price.toLocaleString("vi-VN")} VND</span>
              {product.old_price && (
                <span className="fashion-oldprice">{product.old_price.toLocaleString("vi-VN")} VND</span>
              )}
            </div>
