...
const ProductDetail = () => {
    ...
    // =============================
    const thumbnailImages = product.colors?.map(color => color.image).filter(Boolean) as string[] || [];
                    ...
                    <div className="col-lg-5 col-md-4 col-12">
                        ...
                        <Color
                            ...
                            onSelectColor={(color) => {
                                ...
                                const variant = product.variants?.find(v => v.color === color.name && v.size === selectedSize);
                                if (variant?.image) {
